#define NGX_CONFIGURE " --conf-path=/etc/nginx --conf-path=/var/log/nginx --sbin-path=/usr/sbin --with-cc=aarch64-linux-gnu-gcc --without-http_rewrite_module --without-http_gzip_module --without-http_upstream_zone_module --with-http_ssl_module --with-openssl=/home/liaozexin/mec/parts/src/open_source/openssl-1.1.1g"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 6.3.1 20170404 (Linaro GCC 6.3-2017.05) "
#endif
...
#define NGX_CONF_PREFIX  "/var/log/"
#endif


#ifndef NGX_SBIN_PATH
#define NGX_SBIN_PATH  "/usr/sbin"
#endif


#ifndef NGX_CONF_PATH
#define NGX_CONF_PATH  "/var/log/nginx"
#endif
